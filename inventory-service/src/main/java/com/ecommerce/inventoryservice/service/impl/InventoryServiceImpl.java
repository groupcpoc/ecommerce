...
import com.ecommerce.inventoryservice.publisher.KafkaEventPublisher;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    public InventoryResponse getInventory(String productId) {
        ...
        return inventoryMapper.toResponse(item, getReservations(productId));
    }
    ...
    private List<ReservationResponse> getReservations(String productId) {
        List<StockReservation> reservations = stockReservationRepository.findByProductIdOrderByCreatedAtDesc(productId);
        return inventoryMapper.toReservationResponseList(reservations);
    }

    private OrderStockItemResponse toOrderStockItemResponse(StockReservation reservation) {
        InventoryItem item = inventoryItemRepository.findByProductId(reservation.getProductId()).orElse(null);
        return inventoryMapper.toOrderStockItemResponse(reservation, item);
    }
