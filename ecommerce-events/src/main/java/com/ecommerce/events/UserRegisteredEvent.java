...
public class UserRegisteredEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4530711880465923308L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserRegisteredEvent\",\"namespace\":\"com.ecommerce.events\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public UserRegisteredEvent(java.lang.CharSequence userId, java.lang.CharSequence name, java.lang.CharSequence email) {
    this.userId = userId;
    this.name = name;
    this.email = email;
  }
   ...
   */
  public static com.ecommerce.events.UserRegisteredEvent.Builder newBuilder() {
    return new com.ecommerce.events.UserRegisteredEvent.Builder();
  }
   ...
   * @return A new UserRegisteredEvent RecordBuilder
   */
  public static com.ecommerce.events.UserRegisteredEvent.Builder newBuilder(com.ecommerce.events.UserRegisteredEvent.Builder other) {
    if (other == null) {
      return new com.ecommerce.events.UserRegisteredEvent.Builder();
    } else {
      return new com.ecommerce.events.UserRegisteredEvent.Builder(other);
    }
  }
   ...
   * @return A new UserRegisteredEvent RecordBuilder
   */
  public static com.ecommerce.events.UserRegisteredEvent.Builder newBuilder(com.ecommerce.events.UserRegisteredEvent other) {
    if (other == null) {
      return new com.ecommerce.events.UserRegisteredEvent.Builder();
    } else {
      return new com.ecommerce.events.UserRegisteredEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserRegisteredEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ecommerce.events.UserRegisteredEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ecommerce.events.UserRegisteredEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.UserRegisteredEvent.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.UserRegisteredEvent.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.UserRegisteredEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.UserRegisteredEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.UserRegisteredEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.events.UserRegisteredEvent.Builder clearEmail() {
      email = null;
